// Generated by dart2js (NullSafetyMode.sound, csp, deferred-serialization), the Dart to JavaScript compiler version: 2.19.0-13.0.dev.
...
(function dartProgram() {
  ...
  A._connectToServer_closure.prototype = {
    call$1(message) {
      ...
      t1 = t1.__GuaranteeChannel__sink_F;
      t1 === $ && A.throwLateFieldNI("_sink");
      t1.add$1(0, B.C_JsonCodec.decode$2$reviver(0, A._asString(new A._AcceptStructuredCloneDart2Js([], []).convertNativeToDart_AcceptStructuredClone$2$mustCopy(message.data, true)), null));
    },
    $signature: 8
  };
  ...
  A._connectToIframe_closure.prototype = {
    call$1(message) {
      ...
      if (J.$eq$(J.$index$asx(new A._AcceptStructuredCloneDart2Js([], []).convertNativeToDart_AcceptStructuredClone$2$mustCopy(message.data, true), "ready"), true)) {
        ...
        t1 = t1.__GuaranteeChannel__sink_F;
        t1 === $ && A.throwLateFieldNI("_sink");
        t1.add$1(0, J.$index$asx(new A._AcceptStructuredCloneDart2Js([], []).convertNativeToDart_AcceptStructuredClone$2$mustCopy(message.data, true), "data"));
      }
    },
    $signature: 8
  };
