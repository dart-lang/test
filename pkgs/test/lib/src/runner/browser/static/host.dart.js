// Generated by dart2js (, csp, intern-composite-values), the Dart to JavaScript compiler version: 3.8.0-265.0.dev.
...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    _callConstructor(constructorName, args) {
      var t1 = type$.JSObject,
        $constructor = type$.nullable_JavaScriptFunction._as(t1._as(init.G.window)[constructorName]);
      if ($constructor == null)
        return null;
      return A.callConstructor($constructor, args, t1);
    },
    ...
    main() {
      ...
      if ($.$get$_currentUrl().get$queryParameters().$index(0, "debug") === "true")
        t2._as(type$.nullable_JSObject._as(t2._as(t1.document).body).classList).add("debug");
    ...
    _connectToIframe(url, id) {
      var t3, iframe, controller, windowSubscription,
      ...
      iframe = t2._as(t3.createElement.apply(t3, ["iframe"]));
  ...
  A._StreamController.prototype = {
    ...
    addError$2(error, stackTrace) {
      ...
      this._async$_addError$2(_0_0.error, _0_0.stackTrace);
    },
    addError$1(error) {
  ...
  A._BufferingStreamSubscription.prototype = {
    ...
    onError$1(handleError) {
      var _this = this,
        t1 = _this._async$_state;
      if (handleError == null)
        _this._async$_state = (t1 & 4294967263) >>> 0;
      else
  ...
  A._MultiChannel.prototype = {
    ...
    virtualChannel$1(id) {
      ...
      if (_this._multi_channel$_inner == null) {
        ...
        return new A.VirtualChannel(_this, B.C__EmptyStream, new A.NullStreamSink(t2, t1._eval$1("NullStreamSink<1>")), t1._eval$1("VirtualChannel<1>"));
      }
    ...
    _closeInnerChannel$0() {
      ...
      t2 = A.List_List$_of(new A.LinkedHashMapValuesIterable(t1, t2), t2._eval$1("Iterable.E"));
      t2.$flags = 1;
      t2 = t2;
      t3 = t2.length;
      _i = 0;
  ...
  A.main_closure.prototype = {
    call$0() {
      ...
      t1 = init.G;
      play = type$.nullable_JSObject._as(type$.JSObject._as(t1.document).querySelector("#play"));
      play.toString;
      A.EventTarget_addEventListener(play, "click", new A.main__closure1(serverChannel));
      t1.dartTest = type$.JavaScriptObject._as({resume: A._functionToJS0(new A.main__closure2(serverChannel)), restartCurrent: A._functionToJS0(new A.main__closure3(serverChannel))});
    },
    $signature: 2
  };
  A.main__closure.prototype = {
    call$1(message) {
      ...
      $label0$0: {
        ...
        if (_0_4_isSet) {
          ...
          if (t2)
            if ("loadSuite" === _0_4) {
              ...
              if (_0_9 == null)
                t2 = message.containsKey$1("channel");
              else
                t2 = true;
              if (t2)
        ...
        if (t1) {
          t1 = type$.JSObject;
          t1._as(type$.nullable_JSObject._as(t1._as(init.G.document).body).classList).add("paused");
          break $label0$0;
        }
        t1 = false;
        if (_0_4_isSet) {
        ...
        if (t1) {
          t1 = type$.JSObject;
          t1._as(type$.nullable_JSObject._as(t1._as(init.G.document).body).classList).remove("paused");
          break $label0$0;
        }
        id = _null;
        t1 = false;
        if (_0_4_isSet) {
          ...
          if (t2)
            if ("closeSuite" === _0_4) {
              ...
              if (t2 == null)
                t1 = _0_14_isSet ? _0_14 : message.containsKey$1(_s2_);
              else
                t1 = true;
              if (t1)
        ...
        if (t1) {
          ...
          if (t2._as(t1.parentNode) != null)
            type$.JSObject._as(t2._as(t1.parentNode).removeChild(t1));
        ...
        t1 = type$.JSObject;
        t1._as(t1._as(init.G.window).console).warn("Unhandled message from test runner: " + A.S(message));
      }
    },
    $signature: 5
  };
  ...
  (function installTearOffs() {
    ...
    _instance(A._SyncCompleter.prototype, "get$complete", 0, 0, null, ["call$1", "call$0"], ["complete$1", "complete$0"], 34, 0, 0);
    ...
    _instance(_, "get$addError", 0, 1, null, ["call$2", "call$1"], ["addError$2", "addError$1"], 10, 0, 0);
    ...
    _instance(_ = A._GuaranteeSink.prototype, "get$addError", 0, 1, null, ["call$2", "call$1"], ["addError$2", "addError$1"], 10, 0, 0);
    _instance(_, "get$_addError", 0, 1, null, ["call$2", "call$1"], ["_addError$2", "_addError$1"], 10, 0, 0);
...
;
    ...
    B.C__EmptyStream = new A._EmptyStream(A.findType("_EmptyStream<0&>"));
