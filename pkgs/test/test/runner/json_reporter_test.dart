...
void main() {
  ...
  test(
      'runs several successful tests and reports when each completes',
      () => _expectReport('''
      test('success 1', () {});
      test('success 2', () {});
      test('success 3', () {});
  ...
  test(
      'runs several failing tests and reports when each fails',
      () => _expectReport('''
  ...
  test(
      'runs failing tests along with successful tests',
      () => _expectReport('''
      test('failure 1', () => throw TestFailure('oh no'));
      test('success 1', () {});
      test('failure 2', () => throw TestFailure('oh no'));
  ...
  test(
      'gracefully handles multiple test failures in a row',
      () => _expectReport('''
  ...
  test(
      'gracefully handles a test failing after completion',
      () => _expectReport('''
  ...
  test(
      'reports each test in its proper groups',
      () => _expectReport('''
      group('group 1', () {
        group('.2', () {
          group('.3', () {
    ...
    ''', [
            ...
            [
              ...
              groupJson(5,
                  name: 'group 1 .2 .3', parentID: 4, line: 8, column: 11),
  ...
  group('print:', () {
    ...
    test(
        'handles a print after the test completes',
        () => _expectReport('''
        // This completer ensures that the test isolate isn't killed until all
  ...
  group('skip:', () {
    ...
    test(
        'reports the skip reason if available',
        () => _expectReport('''
      ...
      ''', [
              ...
              [
                groupJson(2, testCount: 2),
                testStartJson(3, 'skip 1',
                    skip: 'some reason', line: 6, column: 9),
                printJson(3, 'Skip: some reason', type: 'skip'),
                testDoneJson(3, skipped: true),
                testStartJson(4, 'skip 2',
                    skip: 'or another', line: 7, column: 9),
    ...
    test(
        'runs skipped tests with --run-skipped',
        () => _expectReport(
            '''
        test('skip 1', () {}, skip: 'some reason');
        test('skip 2', () {}, skip: 'or another');
