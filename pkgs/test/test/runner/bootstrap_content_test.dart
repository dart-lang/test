...
import 'package:test_core/src/runner/vm/test_compiler.dart'; // ignore: implementation_imports
...
void main() {
  ...
  group('TestCompilerForLanguageVersion.generateEntrypoint', () {
    test('generates expected output', () {
      final bootstrapContent =
          TestCompilerForLanguageVersion.generateEntrypoint(
        Uri.parse('file:///absolute/path/to/test/my_test.dart'),
        '',
      );
