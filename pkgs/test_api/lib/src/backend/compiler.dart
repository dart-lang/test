...
class Compiler {
  ...
  static const Compiler dart2js = Compiler('Dart2Js', 'dart2js');

  /// Experimental Dart to Wasm compiler.
  static const Compiler dart2wasm = Compiler('Dart2WASM', 'dart2wasm');

  /// The standard compiler for vm tests, compiles tests to kernel before
  /// running them on the VM.
  static const Compiler kernel = Compiler('Kernel', 'kernel');
