...
void main() {
  test('length', () {
    check(_testIterable).hasLengthWhich(it()..equals(2));
  });
  test('first', () {
    check(_testIterable).hasFirstWhich(it()..equals(0));
  });
  test('last', () {
    check(_testIterable).hasLastWhich(it()..equals(1));
  });
  test('single', () {
    check([42]).hasSingleWhich(it()..equals(42));
  });
  ...
  group('containsInOrder', () {
    ...
    test('can be described', () {
      check(it<Iterable>()..containsInOrder([1, 2, 3])).hasDescriptionWhich(
