  ...
  group('FutureChecks', () {
    group('completes', () {
      ...
      test('can be described', () async {
        ...
        await check(it<Future<int>>()..completes().which(it()..equals(42)))
            .asyncDescription
            .which(it()
              ..deepEquals([
    ...
    group('throws', () {
      ...
      test('can be described', () async {
        await check(it<Future<void>>()..throws())
            .asyncDescription
  ...
  group('StreamChecks', () {
    group('emits', () {
      test('succeeds for a stream that emits a value', () async {
        await check(_countingStream(5)).emits().which(it()..equals(0));
      });
      ...
      test('can be described', () async {
        ...
        await check(it<StreamQueue<int>>()..emits().which(it()..equals(42)))
            .asyncDescription
            .which(it()
              ..deepEquals([
                '  emits a value that:',
    ...
    group('emitsError', () {
      ...
      test('uses a transaction', () async {
        ...
        await check(queue).emits().which((it()..equals(0)));
      });
    });
    ...
    group('mayEmit', () {
      ...
      test('consumes a matching event', () async {
        ...
        await check(queue).emits().which(it()..equals(1));
      });
