// Generated by dart2js, the Dart to JavaScript compiler version: 1.22.0-dev.10.1.
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    convertRtiToRuntimeType: function(rti) {
      ...
      if (rti == null)
        ...
        $arguments = [];
        for (i = 1; i < t1; ++i)
          $arguments.push(H.convertRtiToRuntimeType(list[i]));
        return new H.RuntimeTypeGeneric($name, $arguments, rti);
      } else if ("func" in rti)
        return C.C_DynamicRuntimeType;
      else
    ...
    }, "call$1", "async___nullDataHandler$closure", 2, 0, 39, 8],
    ...
    _rootFork: [function($self, $parent, zone, specification, zoneValues) {
      ...
      return t1;
    }, "call$5", "async___rootFork$closure", 10, 0, 45, 0, 2, 1, 28, 29],
    ...
    _SyncCompleter: {
      ...
      complete$1: [function(_, value) {
        ...
        return this.complete$1($receiver, null);
      }, "complete$0", "call$1", "call$0", "get$complete", 0, 2, 24, 5, 8],
      _completeError$2: function(error, stackTrace) {
    ...
    _StreamController: {
      ...
      }, "addError$1", "call$2", "call$1", "get$addError", 2, 2, 32, 5, 3, 4],
      close$0: [function(_) {
        var t1 = this._state;
        if ((t1 & 4) !== 0)
    ...
    _ZoneDelegate: {
      ...
      errorCallback$3: [function(zone, error, stackTrace) {
        ...
        if (implZone === C.C__RootZone)
          return;
        return implementation.$function.call$5(implZone, P._parentDelegate(implZone), zone, error, stackTrace);
      }, "call$3", "get$errorCallback", 6, 0, 37],
      ...
      }, "call$3", "get$createPeriodicTimer", 6, 0, 18],
    ...
    runZoned_closure: {
      ...
      call$5: [function($self, $parent, zone, error, stackTrace) {
        ...
        try {
          t1 = this.onError;
          if (H.buildFunctionType(H.convertRtiToRuntimeType(null), [H.getDynamicRuntimeType(), H.buildInterfaceType(P.StackTrace)])._isTest$1(t1)) {
    ...
    }, "call$1", "core_Uri_decodeComponent$closure", 2, 0, 30, 38],
    ...
    _connectToServer: function() {
      ...
      controller = B.StreamChannelController$(true, true, null);
      W._EventStreamSubscription$(webSocket, "message", new M._connectToServer_closure(controller), false, W.MessageEvent);
    ...
    _connectToIframe: function(url, id) {
      var t1, iframe, t2, controller, readyCompleter;
      t1 = document;
      iframe = t1.createElement("iframe");
      $.$get$_iframes().$indexSet(0, id, iframe);
      t2 = J.getInterceptor$x(iframe);
      t2.set$width(iframe, "800");
      t2.set$height(iframe, "600");
      t2.set$src(iframe, url);
      t1.body.appendChild(iframe);
      controller = B.StreamChannelController$(true, true, null);
      readyCompleter = new P._AsyncCompleter(new P._Future(0, $.Zone__current, null, [null]), [null]);
      W._EventStreamSubscription$(window, "message", new M._connectToIframe_closure(iframe, controller, readyCompleter), false, W.MessageEvent);
      t1 = controller._local._streamController;
      t1.toString;
    ...
    main_closure: {
      ...
      call$0: [function() {
        ...
        W._EventStreamSubscription$(t1._html$_target, t1._eventType, new M.main__closure1(serverChannel), false, H.getTypeArgumentByIndex(t1, 0));
    ...
    _connectToIframe_closure0: {
      "^": "Closure:38;iframe,readyCompleter",
      call$1: [function(message) {
...
;
  ...
  $ = new Isolate();
  init.metadata = ["self", "zone", "parent", "error", "stackTrace", null, "_", "f", "value", "line", "message", "frame", "trace", "arg", "result", "callback", "data", "key", "each", "duration", "arg2", "arg1", "element", "x", "e", "object", "arg4", "arg3", "specification", "zoneValues", "arguments", "isolate", "errorCode", "closure", "k", "v", 0, "numberOfArguments", "encodedComponent", "s", "sender"];
  init.types = [{func: 1, args: [,]}, {func: 1}, {func: 1, v: true}, {func: 1, args: [,,]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, v: true, args: [,], opt: [P.StackTrace]}, {func: 1, v: true, args: [P.String]}, {func: 1, v: true, args: [P.Uint8List, P.String, P.int]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, args: [, P.StackTrace]}, {func: 1, ret: P.Zone, named: {specification: P.ZoneSpecification, zoneValues: P.Map}}, {func: 1, ret: P.AsyncError, args: [P.Object, P.StackTrace]}, {func: 1, ret: P.Timer, args: [P.Duration, {func: 1, v: true}]}, {func: 1, ret: P.Timer, args: [P.Duration, {func: 1, v: true, args: [P.Timer]}]}, {func: 1, ret: P.String, args: [P.int]}, {func: 1, v: true, args: [P.Zone, {func: 1}]}, {func: 1, args: [P.String,,]}, {func: 1, ret: P.Timer, args: [P.Zone, P.Duration, {func: 1, v: true}]}, {func: 1, ret: P.Timer, args: [P.Zone, P.Duration, {func: 1, v: true, args: [P.Timer]}]}, {func: 1, v: true, args: [P.Zone, P.String]}, {func: 1, ret: P.Zone, args: [P.Zone, P.ZoneSpecification, P.Map]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.int,,]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, v: true, opt: [,]}, {func: 1, args: [P.String]}, {func: 1, args: [,], opt: [,]}, {func: 1, args: [P.Zone, P.ZoneDelegate, P.Zone,, P.StackTrace]}, {func: 1, args: [P.bool]}, {func: 1, ret: P.int, args: [, P.int]}, {func: 1, ret: P.String, args: [P.String]}, {func: 1, args: [P.Symbol0,,]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, v: true, args: [P.String, P.int]}, {func: 1, v: true, args: [P.String], opt: [,]}, {func: 1, ret: P.int, args: [P.int, P.int]}, {func: 1, ret: P.Uint8List, args: [,,]}, {func: 1, ret: P.AsyncError, args: [P.Zone, P.Object, P.StackTrace]}, {func: 1, ret: P.Future, args: [,]}, {func: 1, v: true, args: [,]}, {func: 1, ret: P.AsyncError, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Object, P.StackTrace]}, {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone, {func: 1}]}, {func: 1, ret: P.Timer, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Duration, {func: 1, v: true}]}, {func: 1, ret: P.Timer, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Duration, {func: 1, v: true, args: [P.Timer]}]}, {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone, P.String]}, {func: 1, ret: P.Zone, args: [P.Zone, P.ZoneDelegate, P.Zone, P.ZoneSpecification, P.Map]}, {func: 1, v: true, args: [P.int, P.int]}];
